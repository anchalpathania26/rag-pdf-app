...
class FaissVectorStore:
    ...
    def build_from_documents(self, documents: List[Any]):
        ...
        # ✅ Safety check
        if not chunks:
            raise ValueError("❌ No chunks created from documents. Check your PDF.")

        embeddings = emb_pipe.embed_chunks(chunks)

        # ✅ Safety check
        if embeddings is None or len(embeddings) == 0:
            raise ValueError("❌ No embeddings generated. PDF may be empty or unreadable.")
